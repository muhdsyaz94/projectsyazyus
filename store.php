          ...
          <div class="row">
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                   ...
                   <h2 class="section-heading mb-5" align="center">
                ...
                <li class="list-unstyled-item list-hours-item d-flex">
                  Monday
                  <span class="ml-auto">7:00 AM to 5:00 PM</span>
                </li>
                <li class="list-unstyled-item list-hours-item d-flex">
                  Tuesday
                  <span class="ml-auto">7:00 AM to 5:00 PM</span>
...
Address : Suite 23-4, Plaza Cheong Hin, Jalan SP 2/1, Taman Serdang Perdana, Sec. 2, 43300 Seri Kembangan, Selangor, Malaysia
              ...
              <p class="mb-0" align="center">
              	<small>
                	<em><strong>Payment</strong></em> <br>
Payment upon delivery. Cash only. </br>
</small></p>
</br>
 <p class="mb-0" align="center">
              	<small>
<em><strong>Delivery Coverage </strong></em><br>
Only available in certain Kuala Lumpur and Serdang area. 
Please view the selected area <a href="support/coverage-phases.pdf" >here</a>
</small></p>
  ...
  <!-- Form JS ///////////////////////////////////////////////////////////////////////////--> 
    <script type="text/javascript" src="js/jquery-1.11.0.min.js"></script> <!-- jquery-1.10.2.min.js -->
    <script type="text/javascript" src="js/jquery.validate.min.js"></script> <!-- http://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.1/jquery.validate.min.js -->
  </body>
